...
namespace BL
{
    ...
    {
        public static ML.Result GetByIdMunicipio(int? IdMunicípio)
        {
            ...
            try
            {
                ...
                {
                    var listaColonias = context.ColoniaGetByIdMunicipioDTO.FromSqlRaw($"EXEC ColoniaGetByIdMunicipio {IdMunicípio}").ToList();
